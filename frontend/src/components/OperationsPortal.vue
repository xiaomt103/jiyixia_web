...
const views = {
  dashboard: { title: '经营总览', tabs: ['数据总览', '经营分析', '报表中心'], filters: ['今天', '昨天', '上周'], focus: '本月', menu: ['经营摘要', '待办队列', '风险提醒'], nodes: [{ title: '采集', text: '汇总各模块数据' }, { title: '诊断', text: '识别待办和风险' }, { title: '复盘', text: '沉淀经营报表' }], description: '跨模块经营摘要。', columns: ['事项', '模块', '金额', '时间'], inputLabel: '摘要标题', amountLabel: '关联金额（分）', placeholder: '新增经营摘要', createTitle: '新增经营摘要' },
  booking: { title: '预约', tabs: ['预约日历', '到店跟进', '爽约记录'], filters: ['今天', '明天', '本周'], focus: '待到店', menu: ['预约列表', '到店确认', '改期记录'], nodes: [{ title: '预约', text: '锁定服务时间' }, { title: '提醒', text: '到店前触达' }, { title: '核销', text: '确认服务完成' }], description: '按时间管理预约和到店。', columns: ['预约事项', '会员', '预约时间'], inputLabel: '预约事项', amountLabel: '预约定金（分）', placeholder: '例如：明天 10:30 到店', createTitle: '新增预约' },
  order: { title: '订单', tabs: ['订单看板', '履约中', '售后'], filters: ['待确认', '履约中', '已完成'], focus: '全部订单', menu: ['订单列表', '履约跟进', '退款售后'], nodes: [{ title: '下单', text: '生成交易事项' }, { title: '履约', text: '跟踪服务交付' }, { title: '售后', text: '处理退款和异常' }], description: '跟踪会员订单履约。', columns: ['订单事项', '金额', '时间'], inputLabel: '订单事项', amountLabel: '订单金额（分）', placeholder: '例如：年度会员订单', createTitle: '新增订单事项' },
  marketing: { title: '营销', tabs: ['活动计划', '触达记录', '转化分析'], filters: ['短信', '微信', '优惠券'], focus: '进行中', menu: ['活动列表', '触达任务', '转化记录'], nodes: [{ title: '圈选', text: '筛选目标会员' }, { title: '触达', text: '执行活动消息' }, { title: '转化', text: '统计预算产出' }], description: '管理续费提醒和活动触达。', columns: ['活动名称', '预算', '时间'], inputLabel: '活动名称', amountLabel: '活动预算（分）', placeholder: '例如：六月续费提醒', createTitle: '新增营销活动' },
  finance: { title: '财务', tabs: ['收款流水', '支出记录', '对账'], filters: ['收入', '支出', '待确认'], focus: '本月', menu: ['财务流水', '收入汇总', '支出记录'], nodes: [{ title: '记账', text: '登记收入支出' }, { title: '对账', text: '核对订单流水' }, { title: '报表', text: '输出经营数据' }], description: '记录收款、支出和对账事项。', columns: ['流水事项', '金额', '时间'], inputLabel: '流水事项', amountLabel: '金额（分）', placeholder: '例如：会员收入日报', createTitle: '新增财务记录' },
  settings: { title: '设置', tabs: ['系统配置', '权限', '通知'], filters: ['基础', '权限', '模板'], focus: '配置项', menu: ['配置记录', '权限变更', '通知模板'], nodes: [{ title: '配置', text: '维护基础参数' }, { title: '权限', text: '控制后台角色' }, { title: '通知', text: '管理消息模板' }], description: '沉淀系统配置和权限变更记录。', columns: ['配置事项', '模块', '时间'], inputLabel: '配置事项', amountLabel: '影响金额（分）', placeholder: '例如：新增店长角色', createTitle: '新增配置记录' }
}
